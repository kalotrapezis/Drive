  ...
  interface Window {
    drive: {
      ...
      imports: {
        ...
        run(kind: 'photos' | 'files', sources: string[], driveId: string | null, move: boolean): Promise<{ imported: number; skipped: number; failed: string[]; total: number; stopped?: boolean }>
        cancel(): Promise<void>
